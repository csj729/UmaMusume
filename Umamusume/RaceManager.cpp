...
void RaceManager::SelectPlayerHorse(const std::vector<Horse>& PlayerList, Horse& player)
{
    ...
    while (true)
    {
        if (selNum < 1 || selNum >PlayerList.size())
        {
            std::cout << "잘못된 입력입니다!\n";
            Sleep(500);
        }
        ...
        else
        {
            ...
            std::cout << player.GetName() << "을 선택했습니다!!\n";

            std::cout << "┌────────────────────── 말 정보 ──────────────────────┐\n";
            std::cout << "│ 이름       : " << player.GetName() << "\n";
            std::cout << "│ 속도       : " << player.GetBaseSpeed() << "\n";
            std::cout << "│ 스태미나   : " << player.GetMaxStamina() << "\n";
            std::cout << "│ 지능       : " << player.GetIntel() << "\n";
            std::cout << "└──────────────────────────────────────────────────────┘\n";
            Sleep(2000);
            break;
        }
